...
=======
            <div id="combatScreen" className="d-flex flex-wrap align-content-center justify-content-center" style={{  height: 600, width: 600, position: 'relative', backgroundImage: { background } }}>
