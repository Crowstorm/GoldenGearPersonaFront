...
class StorageOutside extends React.Component{
    ...
    render(){
        ...
        if((this.props.charPosition.x === 11 && this.props.charPosition.y === 19) || (this.props.charPosition.x === 11 && this.props.charPosition.y === 20)){
            this.props.setCharacterPosition(10, 20);
            document.removeEventListener("keydown", this.handleKeyDown);
            this.props.changeLevel('Storage Inside');
